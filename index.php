...
<html>
    <head>
        ...
        <link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,600" 
    ...
    <body class="homepage">
            ...
            <div id="header" class="container">
                ...
                <nav id="nav">
                    <ul>
                        ...
                        <li class="break"><a href="login.php">Login</a></li>
        ...
        <div id="footer-wrapper">
            ...
            <div id="footer" class="container">
                <header class="major">
                    <h2>Footer Something</h2>
                    <span>neque semper magna lorem ipsum feugiat veroeros lorem ipsum dolore.</span>
                </header>
                <div class="row">
                    <section class="6u">
